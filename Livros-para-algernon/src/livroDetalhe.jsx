 { /* seção dos detalhes de cada livro */ }

  { /* useParams para ler o id */ }
...
import './Style/LivroDetalhe.css'
 ...
 { /* import do useCart para manipular o carrinho */ }
import { useCart } from "./context/CartContext";

 { /* import do useNavigate para voltar a pagina anterior*/ }
...
export default function LivroDetalhe() {
  ...
  const { addToCart } = useCart();
   ...
   { /* função que adiciona e navega para o carrinho */ }
